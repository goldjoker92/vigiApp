...
export default function PickerHeureCustom({ initialHour = 8, initialMinute = 0, onConfirm, onCancel }) {
      ...
      <View style={styles.row}>
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            ...
            >
              <Text style={[styles.text, hour === item && styles.selectedText]}>{item.toString().padStart(2, "0")}</Text>
            </TouchableOpacity>
          )}
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            ...
            >
              <Text style={[styles.text, minute === item && styles.selectedText]}>{item.toString().padStart(2, "0")}</Text>
            </TouchableOpacity>
          )}
          showsHorizontalScrollIndicator={false}
        />
