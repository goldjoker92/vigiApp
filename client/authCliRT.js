...
function decodeJwt(token) {
  ...
  try { return base64UrlToJson(payload); } catch { return null; }
}
...
export async function logout() { deleteSession(); return { ok: true }; }
...
export function readSessionFile() { return readSession(); }
