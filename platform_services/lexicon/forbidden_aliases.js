...
FAMILIES.push({
  ...
  terms: [
    ...
    "comando vermelho", "cv", "c.v.",
    "primeiro comando da capital", "primeiro comando", "pcc", "p.c.c.",
    "terceiro comando puro", "terceiro comando", "tcp", "t.c.p.",
    "amigos dos amigos", "ada", "a.d.a.",
    "familia do norte", "família do norte", "fdn", "f.d.n.",
    "guardioes do estado", "guardiões do estado", "gde", "g.d.e.",
    "bonde dos 40", "b40", "b.40",
    "primeiro grupo catarinense", "pgc", "p.g.c.",
    "os manos", "bala na cara",
    // argot/obfus de rue (fréquent CE/NE)
    "okaida", "al qaeda", "alqaeda", "al-qaeda",
    "sindicato do crime", "sindicato", "crime organizado",
  ],
  exceptions: [
...
const _STRICT_ALIASES = [
  ...
  { family: "gangs_br", patterns: ["p\\.c\\.c\\.", "p c c", "primeiro\\s*comando\\s*(?:da\\s*capital)?"] },
